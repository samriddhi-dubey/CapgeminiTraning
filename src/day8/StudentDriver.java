...
public class StudentDriver {
	public static void main(String[] args) {
		...
		//Step-1: goes to the constructor of the driver class having Student(), loads all the non-static members of the class, assigns default values to the variables
		...
		//Step-2: comes back to this class, reassigns the default values to the assigned values
//		obj1.name = "Sam";
//		obj1.marks = 89.23;
//		obj1.id = 1;
